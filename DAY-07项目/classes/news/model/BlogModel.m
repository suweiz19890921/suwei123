...
-(id)initWithDict:(NSDictionary *)dict{
    if (self=[super init]) {
        ...
        size=[self.authorname boundingRectWithSize:CGSizeMake(200, 20) options:NSStringDrawingUsesLineFragmentOrigin attributes:tepDict2 context:nil].size;
       ...
       // 4.
        ...
        NSString * dateStr=[GPUntil createDateStr:self.pubDate];
